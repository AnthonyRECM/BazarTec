    ...
    <div class="container-fluid fondo2"> 
        ...
        <div class="row justify-content-evenly my-5">
            ...
            <div class="col-5 miniFondo1">
                <div class="row align-items-center">
                    <div class="col-6 text-end">
                        <p class="letras2">Inflable de tiburon</p>
                        <p class="letras3">$350</p>
                        <p class="letras3">1.65 mts de largo</p>
                        <p class="letras4 badge text-bg-danger">sin stock</p>
                    </div>
                    <div class="col-6">
                        <img src="./images/tiburon.webp" width="240" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-evenly my-5">
            <div class="col-5 miniFondo1">
                <div class="row align-items-center">
                    <div class="col-6 text-end">
                        <p class="letras2">dona de chocolate</p>
                        <p class="letras3">$180</p>
                        <p class="letras3">120 cm de diametro</p>
                        <p class="letras4 badge text-bg-success">3 en stock</p>
                    </div>
                    <div class="col-6">
                        <img src="./images/dona.webp" width="240" alt="">
                    </div>
                </div>
            </div>
            <div class="col-5 miniFondo1">
                <div class="row align-items-center">
                    <div class="col-6 text-end">
                        <p class="letras2">Dona de fresa</p>
                        <p class="letras3">$180</p>
                        <p class="letras3">120 cm de diametro</p>
                        <p class="letras4 badge text-bg-success">5 en stock</p>
                    </div>
                    <div class="col-6">
                        <img src="./images/dona2.webp" width="240" alt="">
                    </div>
                </div>
            </div>
        </div>
