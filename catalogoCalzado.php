                        ...
                        <li class="submenu">
                            ...
                            <div id="carrito">
                                ...
                                <a href="#" id="vaciar-carrito" class="btn btn-danger">
                                    ...
                                    <a href="./php/procesar_compra.php" id="comprar-carrito" class="btn btn-success">Comprar Carrito</a>
                            </div>
    ...
    <div class="container-fluid fondo2">
        ...
        <div class="row justify-content-evenly my-5">
            ...
            $contador = 1;
                $query = mysqli_query($con, 'SELECT p.id,p.name,p.quantity,p.sale_price,p.media_id,c.name AS categorie,m.file_name AS image
                 FROM products p LEFT JOIN categories c ON c.id = p.categorie_id LEFT JOIN media m ON m.id = p.media_id
                  WHERE categorie_id="2" ORDER BY date DESC');
                while ($consulta = mysqli_fetch_array($query)) {
                    if ($contador%3 == 0){
                        echo "
                        <div class='col-10 miniFondo1 my-4 mx-1 cardd2'>
                            <div class='row'>
                                <div class='col-5 texto-producto2 d-flex align-items-end flex-column pb-1'>
                                    ...
                                    data-bs-placement='left' data-bs-title='Comprar' data-id='".$consulta['id']."'><i class='fa-solid fa-cart-shopping fa-xl' style='color: #c27ef0;'></i></button>
                                </div>
